...
class ConversationPage extends StatefulWidget {
  ...
  const ConversationPage({super.key, required this.address});
...
class _ConversationPageState extends State<ConversationPage> {
  ...
  Future<List<SmsMessage>> _loadMessages(String address) async {
    ...
    try {
      ...
      throw Exception(
        "Failed to load messages for $address.",
  ...
  Future<void> _sendMessage() async {
    ...
    try {
      await telephony.sendSms(to: widget.address, message: messageBody);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        // Use Column to include the input field
        children: [
          Expanded(
            // Make the message list take available space
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.hasError &&
                  ...
                  if (snapshot.data != null && snapshot.data!.isNotEmpty) {
                    ...
                    print(
                      "Error during refresh, showing stale data: ${snapshot.error}",
                    );
                  } else {
                ...
                if (messages.isEmpty &&
                  ...
                  return RefreshIndicator(
                    ...
                    child: LayoutBuilder(
                      // Ensure scroll works for refresh
                      builder:
  ...
  Widget _buildMessageItem(SmsMessage message) {
    ...
    final formattedTime =
        dateTime != null
            ? TimeOfDay.fromDateTime(dateTime).format(
              context,
